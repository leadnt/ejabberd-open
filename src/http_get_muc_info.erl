...
get_muc_info(LServer,Args) ->
	...
	SName = ejabberd_sql:escape(Muc_id),
	SHost = ejabberd_sql:escape(Server_Host),
	Muc_Users = 
		case catch qtalk_sql:get_muc_users(LServer,SName) of
	...
	Owners = 
	case catch qtalk_sql:get_muc_opts(LServer,SName,SHost) of
	{selected,[<<"opts">>],[[Opts]]} ->
